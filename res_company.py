...
class res_company(osv.osv):
     ...
     _columns = {
       ...
       'wsdl_out': fields.char('WSDL Invoice Out', size=256),
       'wsdl_in': fields.char('WSDL Invoice In', size=256),
       'wsdl_pi': fields.char('WSDL Property Investment', size=256),
       'wsdl_ic': fields.char('WSDL Intra-Community', size=256),
       'wsdl_pr': fields.char('WSDL Payment Received', size=256),
       'wsdl_prm': fields.char('WSDL Money Payment Received', size=256),
       'wsdl_ps': fields.char('WSDL Payment Sent', size=256),
       'version_sii': fields.char('Versión SII AEAT', size=32),
     }
